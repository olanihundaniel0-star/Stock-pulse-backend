...
Backend service for StockPulse, a full-stack inventory management system
...
- Stock operations with full audit trail
- Transaction history with user attribution

## Getting Started
```bash
git clone https://github.com/olanihundaniel0-star/Stock-pulse-backend
